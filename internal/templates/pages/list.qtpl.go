...
//line ../templates/pages/list.qtpl:1
package pages

//line ../templates/pages/list.qtpl:1
import "cms/internal/models"

//line ../templates/pages/list.qtpl:2
import "cms/internal/templates/layouts"

//line ../templates/pages/list.qtpl:3
import "strings"

//line ../templates/pages/list.qtpl:5
import (
	qtio422016 "io"
...
//line ../templates/pages/list.qtpl:87
	qw422016.N().S(`
    `)
//line ../templates/pages/list.qtpl:88
	qw422016.N().S(layouts.BaseLayout(data, pageContent))
//line ../templates/pages/list.qtpl:88
	qw422016.N().S(`
`)
//line ../templates/pages/list.qtpl:89
}
