...
//line ../templates/pages/login.qtpl:1
package pages

//line ../templates/pages/login.qtpl:1
import "cms/internal/models"

//line ../templates/pages/login.qtpl:2
import "cms/internal/templates/layouts"

//line ../templates/pages/login.qtpl:3
import "strings"

//line ../templates/pages/login.qtpl:5
import (
	qtio422016 "io"
...
//line ../templates/pages/login.qtpl:5
type LoginData = models.LoginData

//line ../templates/pages/login.qtpl:7
func StreamLoginPage(qw422016 *qt422016.Writer, data *LoginData) {
//line ../templates/pages/login.qtpl:7
	qw422016.N().S(`
    `)
//line ../templates/pages/login.qtpl:9
	pageContent := func() string {
		...
		if data.LockoutMessage != "" {
			sb.WriteString(`<div class="rounded-md bg-yellow-50 p-4 dark:bg-yellow-900/20">`)
		...
		if data.ErrorMessage != "" && data.LockoutMessage == "" {
			sb.WriteString(`<div class="rounded-md bg-red-50 p-4 dark:bg-red-900/20">`)
			sb.WriteString(`<div class="flex">`)
			sb.WriteString(`<div class="flex-shrink-0">`)
			// Error Icon
...
//line ../templates/pages/login.qtpl:82
	qw422016.N().S(`
    `)
//line ../templates/pages/login.qtpl:83
	qw422016.N().S(layouts.PlainLayout(data, pageContent))
//line ../templates/pages/login.qtpl:83
	qw422016.N().S(`
`)
//line ../templates/pages/login.qtpl:84
}
